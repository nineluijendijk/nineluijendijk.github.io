...
```{r Calculate the genetic distances between the sequences, message=FALSE}
...
```{r Visualize unrooted maximum likelihood tree, message=FALSE}
...
```{r Rooting the tree and visualizing it, message=FALSE}
